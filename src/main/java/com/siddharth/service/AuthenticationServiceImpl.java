...
import com.siddharth.enums.Role;
import com.siddharth.exception.UserAlreadyExistException;
import com.siddharth.mapper.RegisterRequestDTOUserMapper;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    private void validateUserNotExists(RegisterRequestDTO request) {
        userRepository.findUserByUsernameOrEmail(request.getUsername(), request.getEmail())
                .ifPresent((item) -> {
                    throw new UserAlreadyExistException("User with username " + item.getUsername() + " already exists");
                });
    }
